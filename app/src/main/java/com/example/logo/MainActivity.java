...
import com.example.logo.Fragment.ImpostazioniFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    private String codicePaziente = "1234";
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            changeContainer(new ImpostazioniFragment(), getResources().getString(R.string.nav_settings), id);

...
public class AppuntamentiFuturiFrg extends AbFrg {
    ...
    protected View viewOfFragment(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_app_futuri,container,false);
        recyclerView = (RecyclerView) v.findViewById(R.id.recycler_app_futuri);

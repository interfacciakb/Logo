...
import com.example.logo.LoginActivity;
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (cf.getText().toString().isEmpty()||name.getText().toString().isEmpty() ||surname.getText().toString().isEmpty()
                    ...
                    android.graphics.Bitmap resizedBitmap = getResizedBitmap(bitmap, 100);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try{
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                viewImage.setImageBitmap(Bitmap.getBitmapFromString(immagine));
